import { House, ApiCharacter } from './api/api-characters.model';
...
//necesito mantener los datos de los personajes, por eso dejo variable
//con todos los personajes, ya que la api no tiene endpoint para
//pedir por id y lo quiero para la vista detalle
export const characterIdEndpoit: ApiCharacter[] = [
  {
